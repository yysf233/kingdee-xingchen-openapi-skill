---
id: "kdcloud-9bfd710f712511eda0b3df014f3e47fe"
title: "客户欠款余额"
source: "金蝶云社区"
url: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=&id=9bfd710f712511eda0b3df014f3e47fe"
author: ""
published_at: ""
product: "金蝶云苍穹"
module: ["进销存云", "往来报表"]
...
-   请求方式：GET
-   请求地址：https://api.kingdee.com/jdy/v2/arap/customer\_debt
...
| 参数名称 | 参数类型 | 是否必填 | 参数说明 |
| --- | --- | --- | --- |
| customer\_id | array | true | 客户ID |
| currency\_id | string | false | 单据币别ID |
...
| 参数名称 | 参数类型 | 参数说明 |
| --- | --- | --- |
| all\_debt | number | 客户应收款余额 |
| customer\_id | string | 客户ID |
| last\_debt | number | 客户上次欠款 |
