---
id: "kdcloud-9d11eed5712511eda0b33734e5d25d3e"
title: "利润表"
source: "金蝶云社区"
url: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=&id=9d11eed5712511eda0b33734e5d25d3e"
author: ""
published_at: ""
product: "金蝶云苍穹"
module: ["财税云", "报表"]
...
-   用途说明：获取利润表
-   请求方式：GET
-   请求地址：https://api.kingdee.com/jdy/v2/fi/profit\_report
...
| --- | --- | --- |
| id | string | id |
| current\_amount | string | 本期（本月）金额 |
| index | string | 行次 |
| last\_year\_amount | string | 上期（去年同期）金额 |
| level | integer | 级次 |
| name | string | 名称 |
| parent\_id | string | 父级id |
| type | string | 类型1-收入2-成本3-税金及附加4-所得税5-净利润6-费用0-忽略 |
| year\_amount | string | 本年累计金额 |
