---
id: "kdcloud-aae8902058ef11eea5e4931d5d37ab00"
title: "委托代销退货保存"
source: "金蝶云社区"
url: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=&id=aae8902058ef11eea5e4931d5d37ab00"
author: ""
published_at: ""
product: "金蝶云苍穹"
module: ["进销存云", "销售单据", "委托代销退货单"]
language: "Kingscript"
version_hint: ["V2"]
keywords: []
quality: "B"
...
-   请求方式：POST
-   请求地址：https://api.kingdee.com/jdy/v2/scm/entrust\_rtn
...
| 参数名称 | 参数类型 | 是否必填 | 参数说明 |
| --- | --- | --- | --- |
| aux\_qty | string | true | 辅助数量（多单位商品，需要使用辅助单位时必填） |
| aux\_unit\_id | string | true | 辅助单位（多单位商品，需要使用辅助单位时必填） |
| is\_free | boolean | true | 是否赠品 |
| material\_id | string | true | 商品id |
| price | string | true | 单价 |
| qty | string | true | 数量 |
| stock\_id | string | true | 仓库id |
| tax\_price | string | true | 含税单价 |
...
| src\_bill\_type\_id | string | false | 源单类型：委托代销单sal\_bill\_entrust |
