---
id: "kdcloud-9c5ca83f712511eda0b35fc9a07dd0a3"
title: "标签列表"
source: "金蝶云社区"
url: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=&id=9c5ca83f712511eda0b35fc9a07dd0a3"
author: ""
published_at: ""
product: "金蝶云苍穹"
module: ["基础资料", "商品资料", "商品标签"]
language: "Unknown"
version_hint: ["V2"]
keywords: []
quality: "B"
...
| 参数名称 | 参数类型 | 是否必填 | 参数说明 |
| --- | --- | --- | --- |
| base\_data\_use\_id | string | true | 标签适用资料id |
...
| parent\_id | string | false | 标签分类id |
| search | string | false | 模糊搜索-名称 |
| un\_page | string | false | 是否分页，1：不分页返回100条数据；默认分页，每页10 |
...
| --- | --- | --- |
| id | string | id |
| group\_id | string | 类别id |
| name | string | 名称 |
| number | string | 编码 |
| parent\_id | string | 标签分类id |
| parent\_name | string | 标签分类名称 |
| parent\_number | string | 标签分类编码 |
