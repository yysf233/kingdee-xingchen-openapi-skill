---
id: "kdcloud-9d9f12d9712511eda0b3370e251a58cd"
title: "委外发料单详情"
source: "金蝶云社区"
url: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=&id=9d9f12d9712511eda0b3370e251a58cd"
author: ""
published_at: ""
product: "金蝶云苍穹"
...
-   用途说明：委外发料单详情
-   请求方式：GET
-   请求地址：https://api.kingdee.com/jdy/v2/pm/mat\_issue\_order\_detail
...
| pick\_type | string | 领料类型，1-普通发料类型，2-委外补料类型 |
| remark | string | 单据备注 |
...
| qty | number | 数量 |
| return\_base\_qty | number | 基本退料数量 |
| return\_qty | number | 退料数量 |
| seq | integer | 分录序号 |
...
| src\_entry\_id | string | 源单材料分录ID |
| src\_product\_entry\_id | string | 源单产品分录ID |
