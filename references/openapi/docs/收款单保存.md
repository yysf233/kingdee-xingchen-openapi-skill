---
id: "kdcloud-9bc23cbb712511eda0b3c7d2a481adb1"
title: "收款单保存"
source: "金蝶云社区"
url: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=&id=9bc23cbb712511eda0b3c7d2a481adb1"
author: ""
published_at: ""
product: "金蝶云苍穹"
...
-   请求方式：POST
-   请求地址：https://api.kingdee.com/jdy/v2/arap/ar\_credit
...
| pay\_entry\_list | List <PayEntry> | true | 收款信息分录 |
...
| is\_multi\_currency | boolean | false | 是否跨币别核销 |
...
| src\_bill\_type\_id | string | true | 源单类型sal\_bill\_outbound、sal\_bill\_inbound、ar\_othercreditbill |
| id | string | false | 分录id(新增时不传，修改时必传) |
| settle\_amount | string | false | 源单已核销金额(修改时必传) |
| src\_comment | string | false | 备注 |
| un\_settle\_amount | string | false | 源单未核销金额(修改时必传) |
...
| settle\_account\_id | string | true | 收款账户id |
...
| id | string | false | 分录id(新增时不传，修改时必传) |
| pay\_type\_id | string | false | 收款方式id |
...
--data-row ' { 	"attachments_url_list":[ 		{ 			"url":"http" 		} 	], 	"bill_date":"2022-01-01", 	"bill_no":"SKD-20200310-00001", 	"currency_id":"1", 	"custom_field":{}, 	"customer_id":"1", 	"dept_id":"1", 	"emp_id":"1", 	"exchange_rate":"1", 	"id":"1", 	"is_multi_currency":true, 	"operate_type":"audit", 	"pay_entry_list":[ 		{ 			"amount":"100", 			"comment":"备注", 			"custom_entity_field":{}, 			"id":"1", 			"pay_type_id":"1", 			"service_fee":"100", 			"settle_account_id":"1", 			"trans_number":"001" 		} 	], 	"remark":"无", 	"source_bill_entry_list":[ 		{ 			"cur_settle_amount":"100", 			"id":"1", 			"settle_amount":"100", 			"src_bill_id":"1", 			"src_bill_type_id":"sal_bill_outbound", 			"src_comment":"备注", 			"un_settle_amount":"1" 		} 	], 	"total_discount_amount":"100" }'
```
