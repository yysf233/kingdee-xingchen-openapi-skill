---
id: "kdcloud-9bcdd57e712511eda0b3f71ce36b16a9"
title: "收款退款单保存"
source: "金蝶云社区"
url: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=&id=9bcdd57e712511eda0b3f71ce36b16a9"
author: ""
published_at: ""
product: "金蝶云苍穹"
...
-   请求方式：POST
-   请求地址：https://api.kingdee.com/jdy/v2/arap/ar\_credit\_ret
...
| cur\_total\_instant\_amount | string | false | 本次退款总金额 |
...
| 参数名称 | 参数类型 | 是否必填 | 参数说明 |
| --- | --- | --- | --- |
| cur\_settle\_amount | string | false | 本次核销金额(不传值时，按源单列表从上往下顺序分摊收款金额) |
| id | string | false | 分录id(新增时不传，修改时必传) |
| src\_bill\_id | string | false | 源单id |
| src\_bill\_type\_id | string | false | 源单类型sal\_bill\_outbound、sal\_bill\_inbound、ar\_othercreditbill |
...
--data-row ' { 	"attachments_url_list":[ 		{ 			"url":"http" 		} 	], 	"bill_date":"2022-01-01", 	"bill_no":"SKD-20200310-00001", 	"cur_total_instant_amount":"100", 	"custom_field":{}, 	"customer_id":"1", 	"id":"1", 	"pay_entry_list":[ 		{ 			"amount":"100", 			"comment":"备注", 			"custom_entity_field":{}, 			"id":"1", 			"pay_type_id":"1", 			"service_fee":"100", 			"settle_account_id":"1" 		} 	], 	"source_bill_entry_list":[ 		{ 			"cur_settle_amount":"100", 			"id":"1", 			"src_bill_id":"1", 			"src_bill_type_id":"sal_bill_outbound", 			"src_comment":"备注" 		} 	] }'
```
