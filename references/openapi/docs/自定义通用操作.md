---
id: "kdcloud-0f688ba7ec9411f08fd11b9d4e0f7e7f"
title: "自定义通用操作"
source: "金蝶云社区"
url: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=&id=0f688ba7ec9411f08fd11b9d4e0f7e7f"
author: ""
published_at: ""
product: "金蝶云苍穹"
...
| 参数名称 | 参数类型 | 是否必填 | 参数说明 |
| --- | --- | --- | --- |
| entity\_number | string | true | 单据标识 |
| id | List <string> | true | id |
| operate\_type | string | true | 操作类型，删除delete、审核audit、反审核unaudit |
...
--data-row ' { 	"entity_number":"ts_45465632434343", 	"id":[], 	"operate_type":"audit" }'
```
