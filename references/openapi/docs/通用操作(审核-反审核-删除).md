---
id: "kdcloud-9e804b8c712511eda0b39f724d124b07"
title: "通用操作(审核\\反审核\\删除)"
source: "金蝶云社区"
url: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=&id=9e804b8c712511eda0b39f724d124b07"
author: ""
published_at: ""
product: "金蝶云苍穹"
module: ["系统设置"]
...
-   用途说明：通用批量操作
-   请求方式：POST
-   请求地址：https://api.kingdee.com/jdy/v2/sys/common\_operate
...
| 参数名称 | 参数类型 | 是否必填 | 参数说明 |
| --- | --- | --- | --- |
| entity\_number | string | false | 单据或基础资料类型，参照《系统设置》-《基础资料及业务单据类型》 |
| ids | List <string> | false | 单据id |
| ignore\_warn | boolean | false | 是否忽略告警信息(如：名称已存在)保存客户，true:忽略，默认false |
| numbers | List <string> | false | 编码 |
| operate\_type | string | false | 操作类型，删除delete、审核audit、反审核unaudit、订单关闭close\_donothing、作废invalid、反作废valid |
...
--data-row ' { 	"entity_number":"sal_bill_outbound", 	"ids":[], 	"ignore_warn":true, 	"numbers":[], 	"operate_type":"delete" }'
```
