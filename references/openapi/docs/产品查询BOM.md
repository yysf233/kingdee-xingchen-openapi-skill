---
id: "kdcloud-774dac6eb08211eeaee3b95748117ca8"
title: "产品查询BOM"
source: "金蝶云社区"
url: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=&id=774dac6eb08211eeaee3b95748117ca8"
author: ""
published_at: ""
product: "金蝶云苍穹"
module: ["基础资料", "BOM单"]
...
-   用途说明：查询BOM
-   请求方式：GET
-   请求地址：https://api.kingdee.com/jdy/v2/bd/bom\_query
...
| 参数名称 | 参数类型 | 是否必填 | 参数说明 |
| --- | --- | --- | --- |
| material\_id | string | true | 产品ID |
| aux\_prop\_id | string | false | 辅助属性ID 辅助商品必录 |
| page | string | false | 当前页，默认1 |
| page\_size | string | false | 每页显示条数默认20 |
