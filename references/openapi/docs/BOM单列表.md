---
id: "kdcloud-9c2c4958712511eda0b361e90d734914"
title: "BOM单列表"
source: "金蝶云社区"
url: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=&id=9c2c4958712511eda0b361e90d734914"
author: ""
published_at: ""
product: "金蝶云苍穹"
module: ["基础资料", "BOM单"]
...
| 参数名称 | 参数类型 | 是否必填 | 参数说明 |
| --- | --- | --- | --- |
| end\_date | string | true | 单据创建时间的结束日期（“yyyy-MM-dd”） |
| start\_date | string | true | 单据创建时间的开始日期（“yyyy-MM-dd”） |
| begin\_date | string | false | 单据最后修改时间，开始日期（格式：“yyyy-MM-dd”，为空表示不过滤） |
| expire\_date | string | false | 单据最后修改时间，结束日期（格式：“yyyy-MM-dd”，为空表示不过滤） |
