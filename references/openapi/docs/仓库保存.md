---
id: "kdcloud-9cd69366712511eda0b387f4b1ef1d33"
title: "仓库保存"
source: "金蝶云社区"
url: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=&id=9cd69366712511eda0b387f4b1ef1d33"
author: ""
published_at: ""
product: "金蝶云苍穹"
module: ["基础资料", "业务资料", "仓库"]
...
| city\_id | string | false | 市id |
| country\_id | string | false | 国家/地区id |
| district\_id | string | false | 区id |
| enable | string | false | 状态，1代表启用，0代表禁用 |
| group\_id | string | false | 分类id |
| group\_name | string | false | 分类名称 |
...
| is\_allow\_freight | boolean | false | 启用仓位管理 |
| is\_allow\_neg | string | false | 是否启用负库存 |
| mobile | string | false | 手机号 |
| phone | string | false | 电话 |
| province\_id | string | false | 省id |
| remark | string | false | 备注 |
| storekeeper\_id | string | false | 仓库管理员id |
| storekeeper\_number | string | false | 仓库管理员编码 |
...
--data-row ' { 	"address":"test地址", 	"city_id":"1", 	"country_id":"1", 	"district_id":"1", 	"enable":"1", 	"group_id":"1", 	"group_name":"名称", 	"group_number":"001", 	"id":"1", 	"ignore_warn":false, 	"is_allow_freight":false, 	"is_allow_neg":"false", 	"mobile":"13000000000", 	"name":"名称", 	"number":"001", 	"phone":"88", 	"province_id":"1", 	"remark":"备注", 	"storekeeper_id":"1", 	"storekeeper_number":"CG001" }'
```
