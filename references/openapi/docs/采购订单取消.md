---
id: "kdcloud-9e519a51712511eda0b301270992bde3"
title: "采购订单取消"
source: "金蝶云社区"
url: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=&id=9e519a51712511eda0b301270992bde3"
author: ""
published_at: ""
product: "金蝶云苍穹"
...
-   用途说明：采购订单取消
-   请求方式：POST
-   请求地址：https://api.kingdee.com/jdy/v2/scm/pur\_order\_cancel
...
| 参数名称 | 参数类型 | 是否必填 | 参数说明 |
| --- | --- | --- | --- |
| entity\_number | string | true | 单据或基础资料类型，参照《常用的基础资料或业务单据编码》 |
| out\_side\_pks | List <string> | true | 外部ID的集合 |
...
--data-row ' { 	"entity_number":"2", 	"out_side_pks":[] }'
```
