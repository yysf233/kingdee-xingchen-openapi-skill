---
id: "kdcloud-9c3040fc712511eda0b335487d560a84"
title: "币别列表"
source: "金蝶云社区"
url: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=&id=9c3040fc712511eda0b335487d560a84"
author: ""
published_at: ""
product: "金蝶云苍穹"
module: ["基础资料", "财务资料", "币别"]
...
| --- | --- | --- |
| id | string | id |
| amt\_precision | string | 金额小数位 |
| enable | integer | 状态(1:启用 0:禁用 -1：不限) |
| exc\_type | string | \=汇率类型，1：固定汇率，2：浮动汇率 |
| name | string | 名称 |
| number | string | 编码 |
| price\_precision | string | 单价小数位 |
| rate | string | 汇率 |
