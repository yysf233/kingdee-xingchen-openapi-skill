---
id: "kdcloud-b0f7dc61d40a11ef9c571dd22d8dd40e"
title: "收料通知单详情"
source: "金蝶云社区"
url: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=&id=b0f7dc61d40a11ef9c571dd22d8dd40e"
author: ""
published_at: ""
product: "金蝶云苍穹"
...
-   用途说明：收料通知单详情
-   请求方式：GET
-   请求地址：https://api.kingdee.com/jdy/v2/scm/pur\_mat\_rec\_notice\_detail
...
| attachments\_url | List <AttachmentsUrl> | 上传的附件url |
...
| contact\_address | string | 供应商联系地址 [敏感数据解密](https://open.jdy.com/#/files/api/detail?id=d7046d818dc111ee860d0fedad361070&noside=true) |
...
| contact\_linkman | string | 供应商发货地址-联系人 |
...
| id | string | 单据ID |
| io\_status | string | 入库执行状态： （未执行：A，部分执行：Z，全部执行：C） |
...
| act\_non\_tax\_price | number | 实际不含税单价 |
...
| bill\_dis\_before\_amount | number | 整单折前价税合计 |
...
| def\_float\_qty | number | 辅助基本数量，是指浮动单位对应的数量 |
| dis\_price | number | 折后单价 |
| discount | number | 折扣（小数） |
| id | string | 分录ID |
| in\_qty | number | 已入库数量 |
...
| tax\_amount\_for | string | 税额(本位币) |
