---
id: "kdcloud-9dbbe9b6712511eda0b33bab14853d52"
title: "组装单详情"
source: "金蝶云社区"
url: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=&id=9dbbe9b6712511eda0b33bab14853d52"
author: ""
published_at: ""
product: "金蝶云苍穹"
...
-   用途说明：组装单详情
-   请求方式：GET
-   请求地址：https://api.kingdee.com/jdy/v2/scm/inv\_assemble\_detail
...
| cost\_fee | string | 费用分摊规则；1: 按成本分摊比例； 2:按数量分摊 |
| cost\_fee\_entity | CostFeeEntity | 组装费用明细 |
...
| cost | number | 出库成本 |
| cost\_share\_percent | number | 成本分摊比例（%），有费用分摊时必填且所有分录合计为100 |
