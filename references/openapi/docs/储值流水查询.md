---
id: "kdcloud-9d6fc669712511eda0b3a32d69d69d98"
title: "储值流水查询"
source: "金蝶云社区"
url: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=&id=9d6fc669712511eda0b3a32d69d69d98"
author: ""
published_at: ""
product: "金蝶云苍穹"
module: ["零售云", "积分储值"]
...
-   用途说明：储值流水查询
-   请求方式：GET
-   请求地址：https://api.kingdee.com/jdy/v2/ls/recharge\_record
...
| --- | --- | --- |
| amount | string | 结存金额 |
| consume\_amount | string | 消费金额 |
| consume\_gift\_amount | string | 消费赠送金额 |
| create\_time | string | 创建时间 |
| gift\_amount | string | 结存赠送金额 |
| id | string |  |
| last\_amount | string | 上次结存金额 |
| last\_gift\_amount | string | 上次结存赠送金额 |
