---
id: "kdcloud-9c67f2e3712511eda0b357a08ad6ab58"
title: "标签分类列表"
source: "金蝶云社区"
url: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=&id=9c67f2e3712511eda0b357a08ad6ab58"
author: ""
published_at: ""
product: "金蝶云苍穹"
module: ["基础资料", "商品资料", "商品标签分类"]
language: "Unknown"
version_hint: ["V2"]
keywords: []
quality: "B"
...
-   用途说明：获取标签分类列表
-   请求方式：GET
-   请求地址：https://api.kingdee.com/jdy/v2/bd/label\_group
...
| 参数名称 | 参数类型 | 参数说明 |
| --- | --- | --- |
| base\_data\_use\_id | string | 标签适用资料id |
| base\_data\_use\_name | string | 标签适用资料名称 |
| base\_data\_use\_number | string | 标签适用资料编码 |
| id | string | id |
| name | string | 名称 |
| number | string | 编码 |
