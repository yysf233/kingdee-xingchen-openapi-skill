---
id: "kdcloud-17294ce4fa8d11ef9452613c00d0cc6d"
title: "查询网络锁"
source: "金蝶云社区"
url: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=&id=17294ce4fa8d11ef9452613c00d0cc6d"
author: ""
published_at: ""
product: "金蝶云苍穹"
module: ["系统设置"]
...
-   用途说明：查询网络锁
-   请求方式：GET
-   请求地址：https://api.kingdee.com/jdy/v2/sys/mutex\_list
...
| 参数名称 | 参数类型 | 是否必填 | 参数说明 |
| --- | --- | --- | --- |
| bill\_type | string | false | 单据或基础资料类型id，参照《系统设置》-《基础资料及业务单据类型》 |
| ids | array | false | 单据或基础资料id集合 |
| page | string | false | 当前页，默认1 |
| page\_size | string | false | 每页显示条数默认10，最大为100 |
...
| entity\_key\_id | string | 单据或基础资料类型id |
| id | string | 网络锁id |
| itself | boolean | 标识是否为当前会话。只有网络锁是当前用户在当前客户端创建时，查询返回为true,否则为false |
| object\_id | string | 单据id |
| operation\_key | string | 操作key,下推:botp\_convert,修改:modify |
