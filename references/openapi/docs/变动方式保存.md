---
id: "kdcloud-72847853cf0a11edbe4c6be54cd43612"
title: "变动方式保存"
source: "金蝶云社区"
url: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=&id=72847853cf0a11edbe4c6be54cd43612"
author: ""
published_at: ""
product: "金蝶云苍穹"
...
-   用途说明：获取变动方式保存
-   请求方式：POST
-   请求地址：https://api.kingdee.com/jdy/v2/fi/fa\_altermode\_save
...
| 参数名称 | 参数类型 | 是否必填 | 参数说明 |
| --- | --- | --- | --- |
| group\_id | string | true | 变动方式类别id |
...
--data-row ' { 	"group_id":"1", 	"id":"1", 	"name":"001", 	"note":"备注001 ", 	"number":"001" }'
```
