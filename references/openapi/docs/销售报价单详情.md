---
id: "kdcloud-559a5510b96011ed83ea352202e05501"
title: "销售报价单详情"
source: "金蝶云社区"
url: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=&id=559a5510b96011ed83ea352202e05501"
author: ""
published_at: ""
product: "金蝶云苍穹"
...
-   用途说明：销售报价单详情
-   请求方式：GET
-   请求地址：https://api.kingdee.com/jdy/v2/scm/sal\_quota\_detail
...
| 参数名称 | 参数类型 | 参数说明 |
| --- | --- | --- |
| settle\_customer\_id | string | 客户信息 |
...
| cost\_fee\_entity | CostFeeEntity | 销售费用明细，没有则传null或不传该字段 |
...
| cus\_bear\_amount | string | 客户承担费用 |
| cus\_bear\_amount\_for | string | 客户承担费用 |
| cus\_bear\_fee\_entry | List <CusBearFeeEntry> | 客户承担费用单据体 |
| cus\_currency\_id | string | 客户承担费用币别id |
| cus\_currency\_name | string | 客户承担费用币别名称 |
| cus\_currency\_number | string | 客户承担费用币别编码 |
| cus\_exchange\_rate | string | 客户承担费用汇率 |
...
| income\_amount\_for | string | 收入金额本位币 |
| income\_comment | string | 客户承担费用备注 |
| income\_name\_id | string | 收入名称id |
| income\_name\_name | string | 收入名称名称 |
| income\_name\_number | string | 收入名称编码 |

**CostFeeEntity**

| 参数名称 | 参数类型 | 参数说明 |
| --- | --- | --- |
| del\_ids | string | 需要删除的销售费用分录ID，多个用英文逗号隔开；已经生成了其他应付单的费用不能删除，前端需要控制 |
