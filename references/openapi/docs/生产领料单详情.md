---
id: "kdcloud-9e27a40d712511eda0b3e1f836292832"
title: "生产领料单详情"
source: "金蝶云社区"
url: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=&id=9e27a40d712511eda0b3e1f836292832"
author: ""
published_at: ""
product: "金蝶云苍穹"
...
-   用途说明：生产领料单详情
-   请求方式：GET
-   请求地址：https://api.kingdee.com/jdy/v2/scm/inv\_pick\_detail
...
| bill\_type\_id | string | 业务id |
| bill\_type\_name | string | 业务类型 |
| bill\_type\_number | string | 业务编码 |
...
| mul\_bill\_label | List <DetailMulBillLabel> | 单据标签 |
| pick\_type | string | 领料类型，1-普通领料类型，2-生产补料类型 |
| pick\_use\_id | string | 领料用途id |
| pick\_use\_name | string | 领料用途 |
| pick\_use\_number | string | 领料用途编码 |
| remark | string | 备注 |
