---
id: "kdcloud-9e246fba712511eda0b3f3ee9008be2d"
title: "库存占用"
source: "金蝶云社区"
url: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=&id=9e246fba712511eda0b3f3ee9008be2d"
author: ""
published_at: ""
product: "金蝶云苍穹"
module: ["进销存云", "仓存报表"]
...
-   用途说明：库存占用
-   请求方式：POST
-   请求地址：https://api.kingdee.com/jdy/v2/scm/inv\_occupy
...
| 参数名称 | 参数类型 | 是否必填 | 参数说明 |
| --- | --- | --- | --- |
| bill\_id | string | true | 单据id |
| bill\_type\_id | string | true | 单据类型；第三方单据传：isv\_bill |
| material\_entity | List <MaterialEntity> | true | 分录 |
| bill\_date | string | false | 单据日期 |
| bill\_no | string | false | 单据编号 |
...
| 参数名称 | 参数类型 | 是否必填 | 参数说明 |
| --- | --- | --- | --- |
| base\_unit | string | true | 基本单位 |
| bill\_entry\_id | string | true | 分录id |
...
| base\_qty | string | false | 基本数量 |
| batch\_no | string | false | 批次号 (批次商品必填) |
| def\_float\_qty | string | false | （如果isReCalcQty为false，此字段必传） |
| kf\_date | string | false | 生产日期 |
| kf\_period | string | false | 保质期天数 |
| kf\_type | string | false | 保质期类型，1：天，2：月，3：年 |
| sn\_list | string | false | 序列号（序列号商品必传，多个序列号使用英文分号分隔） |
...
--data-row ' { 	"bill_date":"2020-08-10 00:00:00", 	"bill_id":"951372470512833536", 	"bill_no":"XF000202008050004.a", 	"bill_type_id":"store_billl", 	"is_re_calc_qty":"true", 	"material_entity":[ 		{ 			"aux_prop_id":"001", 			"aux_prop_name":"名称", 			"aux_qty":"50", 			"aux_unit_id":"1", 			"base_qty":"1", 			"base_unit":"95048862702712799980", 			"batch_no":"2022-05-01", 			"bill_entry_id":"951372803272134656", 			"def_float_qty":"1", 			"kf_date":"2022-05-01", 			"kf_period":"180", 			"kf_type":"1", 			"material_id":"950505500796002304", 			"material_name":"表头仓库商品", 			"material_number":"SP00009", 			"qty":"1", 			"sn_list":"20", 			"sn_list_id":"2", 			"sp_id":"1", 			"space_name":"名称", 			"stock_id":"150505500796002302", 			"stock_name":"test", 			"unit":"95048862702712799988", 			"valid_date":"2022-05-01" 		} 	] }'
```
