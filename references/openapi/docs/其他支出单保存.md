---
id: "kdcloud-9b872f79712511eda0b30726c8d43c3f"
title: "其他支出单保存"
source: "金蝶云社区"
url: "https://open.jdy.com/#/files/api/detail?index=3&categrayId=&id=9b872f79712511eda0b30726c8d43c3f"
author: ""
published_at: ""
product: "金蝶云苍穹"
...
-   请求方式：POST
-   请求地址：https://api.kingdee.com/jdy/v2/arap/ap\_other\_credit
...
| pay\_entry\_list | List <PayEntry> | true | 应付信息分录 |
...
| pay\_type\_id | string | true | 支出类别id |
...
| no\_tax\_amount | string | false | 不含税金额(修改时需要带上) |
| tax\_rate | string | false | 税率 |
...
| 参数名称 | 参数类型 | 是否必填 | 参数说明 |
| --- | --- | --- | --- |
| instant\_amount | string | true | 付款金额 |
| instant\_settle\_account\_id | string | true | 付款账户id |
| custom\_entity\_field | Map <string> | false | 自定义字段[使用指南](https://open.jdy.com/#/files/api/detail?id=76567ff2a06311edaa4b3d71bf0fce53&noside=true) |
| id | string | false | 分录id(新增时不传，修改时必传) |
| instant\_comment | string | false | 备注 |
| instant\_pay\_type\_id | string | false | 支出类别id |
...
--data-row ' { 	"attachments_url_list":[ 		{ 			"url":"http" 		} 	], 	"bill_date":"2022-01-01", 	"bill_no":"SKD-20200310-000011", 	"currency_id":"1", 	"custom_field":{}, 	"dept_id":"1", 	"emp_id":"1", 	"exchange_rate":"1", 	"id":"1", 	"instantpayfromtoentry":[ 		{ 			"custom_entity_field":{}, 			"id":"1", 			"instant_amount":"100", 			"instant_comment":"备注", 			"instant_pay_type_id":"1", 			"instant_settle_account_id":"1", 			"instant_trans_number":"001", 			"seq":"1", 			"service_fee":"100" 		} 	], 	"operate_type":"audit", 	"pay_entry_list":[ 		{ 			"amount":"100", 			"comment":"备注", 			"custom_entity_field":{}, 			"id":"1", 			"no_tax_amount":"10", 			"pay_type_id":"1", 			"tax_rate":"1", 			"trans_number":"001" 		} 	], 	"remark":"无", 	"supplier_id":"1", 	"total_discount_amount":"100" }'
```
